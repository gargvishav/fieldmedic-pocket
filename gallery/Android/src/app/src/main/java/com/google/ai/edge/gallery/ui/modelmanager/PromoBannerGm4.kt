...
fun PromoBannerGm4(onDismiss: () -> Unit, modifier: Modifier = Modifier) {
  ...
  Box(modifier = modifier) {
    ...
    Column(
      ...
      Text(text = "Built for field health workers", style = MaterialTheme.typography.titleMedium)
      Text(
        "FieldMedic runs entirely offline using Gemma 4 — designed to give fast triage guidance when there is no signal.",
